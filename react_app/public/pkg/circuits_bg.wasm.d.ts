/* tslint:disable */
/* eslint-disable */
export function prove(a: number, b: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1e88871afbf88eeb(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h8a5a19da7a480f15(a: number, b: number, c: number, d: number): void;
